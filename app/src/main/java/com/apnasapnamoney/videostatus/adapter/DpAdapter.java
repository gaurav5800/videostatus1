...
import com.apnasapnamoney.videostatus.views.videos.UnderDP;

public class DpAdapter extends RecyclerView.Adapter<DpAdapter.MyViewHolder>  {

    Context con;

    public DpAdapter(Context con){
        this.con=con;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        holder.main_lay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(con, UnderDP.class);
